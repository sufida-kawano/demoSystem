...
class estimate
{
    ...
    public function action_index()
    {
        ...
        //View呼び出し
        include_once(dirname(__FILE__). "/../view/estimate_list.php");
    }
    public function action_operation($targetId)
    {
        ...
        //View呼び出し
        include_once(dirname(__FILE__). "/../view/estimate_operation.php");
    }
    // 登録・更新処理
    public function action_processing($targetId)
    {
        ...
        redirectUrl("/estimate/operation/$targetId");
    }
        public function action_print($targetId)
    {
        ...
        //View呼び出し
        include_once(dirname(__FILE__). "/../view/estimate_print.php");
    }
}
